...
<div class="kpi-grid">
  ...
  <div class="kpi">
    <div class="kpi-label">Revenu actif (cumulé)</div>
...
<div class="adm-card" style="padding:0;overflow-x:auto">
  <table class="adm-table">
    <thead><tr><th>Membre</th><th>Formule</th><th>Montant</th><th>Statut</th><th>Échéance</th><th>Souscrit</th><th></th></tr></thead>
    <tbody>
      ...
      @empty
        <tr><td colspan="7" style="text-align:center;color:var(--muted);padding:30px">Aucun abonnement.</td></tr>
      @endforelse
    </tbody>
  </table>
</div>
